...
public class LaunchInterceptorConditionCollection {
    ...
    /**
     * LIC #5 check if there exists a set of two consecutive data points where the x-value of the latter data point is
     * greater than the former data point
     * @param points list of radar echos ({@link Point})
     * @return true if there exists a set of two consecutive data points where the x-value of the latter data point is
